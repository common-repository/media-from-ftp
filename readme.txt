...
= Caution!! This plugin will be closed shortly. Please migrate to the next successor plugin as soon as possible. =
...
= 11.17 =
Fixed problem of Access Control. Thanks[Erwan Le Rousseau](https://wpscan.com/).

= 11.16 =
Fixed problem of Access Control. Thanks[Marc Montpas](https://wpscan.com/).

= 11.15 =
Fixed problem of Broken Access Control + Path traversal. Thanks[Dmitrii Ignatyev](https://cleantalk.org/).
